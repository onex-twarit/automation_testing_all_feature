...
def step_impl(context):
    time.sleep(1)
    context.driver.find_element(By.ID, 'group-name').send_keys("remove duplicates")
...
def step_impl(context):
    ...
    fileupload.send_keys('/home/twarit/Desktop/duplicate.csv')
...
def step_impl(context):
    ...
    select.select_by_visible_text("remove duplicates(507)")
