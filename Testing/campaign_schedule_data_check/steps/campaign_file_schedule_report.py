...
@then('click on new sms, click on campaign sms')
def step_impl(context):
    time.sleep(0.5)
...
@then('add campaign \'campaign schedule\', fill the present fields, click on Add')
def step_impl(context):
    time.sleep(2)
...
@then('search with campaign name \'campaign schedule\'')
def step_impl(context):
    time.sleep(1)
    context.driver.find_element(By.ID, 'web_camp').send_keys('campaign schedule')  # search with campaign name
...
@then('verify with name \'campaign schedule\'')
def step_impl(context):
    time.sleep(1)
...
@then('go to scheduled campaign, verify \'campaign schedule\' name')
def step_impl(context):
    time.sleep(0.5)
