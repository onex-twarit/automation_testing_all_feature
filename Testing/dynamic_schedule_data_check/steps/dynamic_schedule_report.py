...
@then('click on new sms, click on dynamic sms')
def step_impl(context):
    time.sleep(0.5)
    context.driver.find_element(By.XPATH, '//*[@id="new_sms"]').click()  # go to NEW SMS

    time.sleep(0.5)
    button = context.driver.find_element(By.XPATH, '//*[@id="dynamic_sms_title"]')
...
@then('add campaign \'dynamic schedule camp\', fill the present fields, click on Add')
def step_impl(context):
    time.sleep(2)
    ...
    context.driver.find_element(By.XPATH,
        ...
        "dynamic schedule camp")  # campaign name
    time.sleep(0.5)
...
@then('search with campaign name \'dynamic schedule camp\'')
def step_impl(context):
    time.sleep(1)
    context.driver.find_element(By.ID, 'web_camp').send_keys('dynamic schedule camp')  # search with campaign name
...
@then('verify with name \'dynamic schedule camp\'')
def step_impl(context):
    time.sleep(1)
...
@then('go to scheduled campaign, verify \'dynamic schedule camp\' name')
def step_impl(context):
    time.sleep(0.5)
