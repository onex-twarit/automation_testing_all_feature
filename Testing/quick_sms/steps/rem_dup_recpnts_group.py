...
@then('add recipients and group remove dup then check split schedule, send it')
...
@then('on sms confirmation window verify numbers and credits')
def step_impl(context):
    # on sms confirmation window ---->
    # check duplicate num
    time.sleep(1)
