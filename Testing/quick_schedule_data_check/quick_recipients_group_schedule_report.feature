Feature: Quick SMS with recipients and group schedule
    ...
    Scenario: Schedule
        ...
        And click on new sms, click on quick sms
        And add campaign 'quick schedule', fill the present fields, click on Add
        ...
        And verify with name 'quick schedule'
        And go to summary tab check all and web(recipients and group)
        And go to scheduled campaign, verify 'quick schedule' name
        And delete schedule
        And close
