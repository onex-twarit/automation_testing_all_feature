...
@then('add campaign \'quick recurrence\', fill the present fields, click on Add')
...
@then('verify with name \'quick recurrence\'')
def step_impl(context):
    time.sleep(2)
    ...
    if text == 'quick recurrence':
        assert True, "Test Passed"
    else:
        assert False, "----->> Failed"


@then('go to scheduled campaign, verify \'quick recurrence\' name')
def step_impl(context):
    time.sleep(2)
