Feature: Unicode SMS with recipients and group schedule
    ...
    Scenario: Schedule
        ...
        And add campaign 'unicode schedule', fill the present fields, click on Add
        ...
        And verify with name 'unicode schedule'
        And go to summary tab check all and web(recipients and group)
        And go to scheduled campaign, verify 'unicode schedule' name
        And delete schedule
        And close
