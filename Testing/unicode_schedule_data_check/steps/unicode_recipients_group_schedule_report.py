...
from unicode_schedule_data_check.steps.unicode_recipients_schedule_report import driver


@then('add campaign \'unicode schedule\', fill the present fields, click on Add')
def step_impl(context):
    ...
    context.driver.find_element(By.XPATH,
        ...
        "unicode schedule")  # campaign name
    time.sleep(0.5)
...
@then('verify with name \'unicode schedule\'')
def step_impl(context):
    time.sleep(2)
...
@then('go to scheduled campaign, verify \'unicode schedule\' name')
def step_impl(context):
    time.sleep(2)
